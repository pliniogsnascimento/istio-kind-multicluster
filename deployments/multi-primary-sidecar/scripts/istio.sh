...
function enable_injection() {
    ...
    kubectl label namespace app1 istio-injection=enabled --context="$context" --overwrite
    kubectl label namespace curl istio-injection=enabled --context="$context" --overwrite
}
